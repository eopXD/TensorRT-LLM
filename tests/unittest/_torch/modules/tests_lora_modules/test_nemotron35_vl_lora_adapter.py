...
def test_vision_only_adapter_is_dropped_entirely(mini_checkpoint, tmp_path):
    ...
    No VLM in the repo routes lora_params to a vision tower. This asserts the
    loader drops every vision key, so a Tier-2 run showing no output change for
    this adapter is evidence rather than a coincidence.
    """
