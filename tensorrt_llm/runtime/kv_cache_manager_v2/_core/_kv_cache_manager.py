...
class KVCacheManager:
    ...
    # Per-iteration suspend/resume (preemption) counters. Manager-level rather than
    # per-life-cycle: suspend/resume is a whole-request event, not a per-pool-group one.
